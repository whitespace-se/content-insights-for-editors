<table width="640" cellspacing="0" cellpadding="0" class="bw-table_content" style="background-color:#FFFFFF;"
    ...
    <tbody>
        <tr>
            <td>
                <table class="bw-table_content" cellspacing="0" cellpadding="0" align="center" width="100%"
                    bgcolor="#ffffff" style="background-color: rgb(255, 255, 255);">
                    <tbody>
                        <tr>
                                ...
                                <table align="center" width="100%">
                                    <tbody>
                                        <tr>
                                            ...
                                            '/source/images/rounder-up.png'; ?>" class="fr-fii fr-dib" width="640"
