  ...
  public function adminNoticeWarnMissingPlugin() {
    ?>
		<div class="notice notice-error">
			<p><?php _e(
     'Broken links plugin is missing. For best experience using this plugin we recommend you activate Broken links',
     'content-insights-for-editors'
   ); ?></p>
			<a href="https://github.com/helsingborg-stad/broken-link-detector"><?php _e(
     'Broken links repository',
     'content-insights-for-editors'
   ); ?></a>
		</div>
		<?php
